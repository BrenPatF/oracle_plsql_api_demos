...
/***************************************************************************************************
Name: emp_ws.pks                        Author: Brendan Furey                      Date: 21-Sep-2019
...
====================================================================================================
This file has the Emp_WS package spec.

***************************************************************************************************/

PROCEDURE Save_Emps(
            p_emp_in_lis                   emp_in_arr,
            x_emp_out_lis              OUT emp_out_arr);
PROCEDURE Get_Dept_Emps(
            p_dep_id                       PLS_INTEGER, 
            x_emp_csr                  OUT SYS_REFCURSOR);
